				...
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
					  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<div class="logo">
							<a class="navbar-brand" href="index.html">Exam Seating Arrangement</a>
						</div>
					</div>
...
$q2=mysqli_query($conn,$q) or die(mysqli_error());
$ro = mysqli_fetch_array($q2);
$rm=$ro['roomno'];
echo "YOUR  SEAT IS ALLOTED IN <br>";
echo "Room:$rm<br>";
...
{ $q5="SELECT*FROM room$rm WHERE col$i=$r";
  $q6=mysqli_query($conn,$q5) or die(mysqli_error());
